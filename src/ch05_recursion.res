...
TestUtils.runTests(__MODULE__, () => {
  TestUtils.test("should calculate factorial(0)", () => assert (factorial(0) == 1))
  TestUtils.test("should calculate factorial(5)", () => assert (factorial(3) == 6))
  TestUtils.test("should calculate factorial(120)", () => assert (factorial(5) == 120))
})
