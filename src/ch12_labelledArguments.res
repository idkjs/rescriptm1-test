...
TestUtils.runTests(__MODULE__, () => {
  TestUtils.test("should calculate modulo", () => assert (1 == modulo(~dividend=7, ~divisor=2)))
  TestUtils.test("should calculate modulo", () => assert (0 == modulo(~dividend=12, ~divisor=4)))
