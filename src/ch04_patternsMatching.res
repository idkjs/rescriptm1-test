...
TestUtils.runTests(__MODULE__, () => {
  TestUtils.test("should say it is a vowel", () => assert (isVowel("e") == true))
  TestUtils.test("should say it is not a vowel", () => assert (isVowel("k") == false))
  TestUtils.test("should say it's not zero", () => assert (nonZero(7) == true))
  TestUtils.test("should say it is zero", () => assert (nonZero(0) == false))
})
